...
<section class="products shopping-cart">
   ...
   <form action="" method="post" class="box">
      ...
      <div class="sub-total"> sub total : <span><span>Rp</span><?= $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?>/-</span> </div>
   ...
   <div class="cart-total">
      <p>grand total : <span><span>Rp</span><?= $grand_total; ?>/-</span></p>
